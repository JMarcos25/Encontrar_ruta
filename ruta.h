 ...
 * @param aris Indica el número de aristas/nodos
 * @param num Indica las coordenas x
 * @param num2 Indica las coordenas y
 */
void imprimir_coordenadas(int aris, int num[MAX], int num2[MAX]);

/**
 * @brief buscar_ruta Busca en las coordenas si existe alguna ruta
 * @param aris Indica el número de numero de aristas/nodos
 * @param num Indica las coordenas x
 * @param num2 Indica las coordenas y
